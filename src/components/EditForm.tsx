...
const EditForm = (props: Props) => {
	...
	return (
		<div className='edit-form__container'>
			...
			<div className='title-form'>{props.editData?.id ? 'Редактирование маркера' : 'Создание маркера'}</div>
			<form onSubmit={formik.handleSubmit}>
				<div>
					...
					<div className='form-group'>
						...
						{(formik.errors.lng && formik.touched.lng) || (formik.errors.lat && formik.touched.lat) ? (
							<div className='alert alert-danger'>{formik.errors.lng || formik.errors.lat}</div>
						) : null}
					</div>
					...
					{(formik.values.type === EventType.EVENT || formik.values.type === EventType.ATTRACTION) && (
						<div className='form-group'>
							<div className='flex-container'>
